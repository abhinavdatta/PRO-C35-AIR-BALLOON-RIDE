...
function draw() {
  ...
  text("press the downarrow to the Hot Air Balloon", 50, 60);
  ...
  balloon.x = balloon.x -10;
    ...
    if (balloon.scale <1){ balloon.y = balloon.y -10; }
    if (balloon.scale >0.1){ balloon.scale = balloon.scale-0.01;}
  } 

  else if(keyDown(DOWN_ARROW)){ balloon.y = balloon.y +10;
    if (balloon.scale <1){ balloon.scale = balloon.scale+0.01; }
  }
